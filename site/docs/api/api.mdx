...
- [AIGatewayRouteRuleBackendRefKind](#aigatewayrouterulebackendrefkind)
...
<ApiField
  name="kind"
  type="[AIGatewayRouteRuleBackendRefKind](#aigatewayrouterulebackendrefkind)"
  required="true"
  defaultValue="AIServiceBackend"
  description="Kind is the kind of the backend, which is either `AIServiceBackend` or `InferencePool` in Gateway API Inference Extension.<br />When this references InferencePool, the selector of the InferencePool is used to select (multiple) AIServiceBackend(s)<br />that can serve the same model sets that the InferencePool binds.<br />Default is AIServiceBackend."
/><ApiField
  name="name"
  type="string"
  required="true"
...
#### AIGatewayRouteRuleBackendRefKind
...
<ApiField
  ...
  type="enum"
  required="false"
  description="AIGatewayRouteRuleBackendRefAIServiceBackend is the kind of the AIServiceBackend.<br />"
/><ApiField
  name="InferencePool"
  type="enum"
  required="false"
  description="AIGatewayRouteRuleBackendRefInferencePool is the kind of the InferencePool in the Gateway API Inference Extension.<br />https://github.com/kubernetes-sigs/gateway-api-inference-extension<br />"
/>
...
/><ApiField
  ...
  type="enum"
  required="false"
  description="APISchemaGCPGemini is the schema followed by Gemini models hosted on GCP.<br />https://cloud.google.com/vertex-ai/docs/reference/rest/v1/projects.locations.endpoints/generateContent?hl=en<br />"
/><ApiField
  name="GCPAnthropic"
  type="enum"
  required="false"
  description="APISchemaGCPAnthropic is the schema followed by Anthropic models hosted on GCP.<br />This is majorly the Anthropic API with some GCP specific parameters as described in below URL.<br />https://docs.anthropic.com/en/api/claude-on-vertex-ai<br />"
/>
#### AWSCredentialsFile
...
<ApiField
  ...
  type="string"
  required="true"
  description="ProjectID is the GCP project ID that the backend is hosted in."
/><ApiField
  name="serviceAccountEmail"
  type="string"
  required="true"
  description="ServiceAccountEmail is the email address of the service account to be used to access GCP."
/><ApiField
...
/><ApiField
  name="GCPIdentityProviderName"
  type="string"
  required="true"
  description="GCPIdentityProviderName refers to the external identity provider whose credentials your workload is using to authenticate to Google Cloud."
/><ApiField
  name="oidc"
  type="[OIDC](https://gateway.envoyproxy.io/docs/api/extension_types/#oidc)"
  required="true"
